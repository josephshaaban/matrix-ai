        ...
        <section className="text-lg max-w-prose mx-auto">
          <h2>
            ...
            <span className="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-white sm:text-4xl">
              MatrixAI Privacy Policy
            </span>
          </h2>
          <p className="mt-8 text-lg text-gray-500">This Privacy Policy ("Policy") outlines how MatrixAI ("MatrixAI," "we," "our," or "us") collects, uses, and protects your personal information when you use our trading profit Growth services. By using our services, you ("you," "your," or "user") consent to the practices described in this Policy.</p>
          ...
          <ul className="text-lg text-gray-500">
            <li>Information provided by you during registration, including your name, email address, and Trading account details.</li>
          ...
          <ul className="text-lg text-gray-500">
            <li>To provide and improve our trading profit growth services, tailoring our strategies to your specific needs and objectives.</li>
          ...
          <p className="text-lg text-gray-500">If you have any questions or concerns regarding this Privacy Policy or our services, please contact us at support@matrix-ai.ae.</p>
          <p className="text-lg text-gray-500">By using MatrixAI's services, you acknowledge that you have read, understood, and agree to this Privacy Policy.</p>
        </section>
      </section>
    </main>
  );
