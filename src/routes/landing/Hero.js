...
import TradingCover from "../../assets/images/trading-icon-cover.png";
          ...
          <section className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
            <section className="lg:py-24">
              <h1 className="mt-4 text-5xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                <span className="block">Matrix AI</span>
                <span className="block text-[color:var(--primary-font-color)]">
                  your TRADING growth secret
                </span>
              </h1>
              <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                Boost your profit on trading with our premium package that
                will skyrocket your gain engagement!
              </p>
              <section className="mt-10 sm:mt-12">
                {loading ? (
                  ...
                  <p className="font-medium text-green-600 sm:text-xl lg:text-lg xl:text-xl">
                    Hold tight! Our representative will contact you shortly via
                    email
                  </p>
                ) : (
                  <form
